...
- [x] F01 단일 서비스 서버 렌더링과 HTTP Basic 단일 사용자 인증 — Next.js/Auth는 편집 기능 단계로 연기
- [x] F02 오늘 요약 화면
- [/] F03 최근 기록 날짜 이동과 날짜 상세 — 월간 Calendar 그리드 남음
- [/] F04 Diary 상세 — 목록·본문 완료, 원문 근거 직접 이동 남음
- [x] F05 Timeline
- [x] F06 날짜·키워드 검색
- [ ] F07 일기 피드백
- [ ] F08 기억 조회·수정·삭제
- [x] F09 기분/건강 기본 차트·목록
- [x] F10 모바일 반응형 레이아웃과 의미 구조 점검
